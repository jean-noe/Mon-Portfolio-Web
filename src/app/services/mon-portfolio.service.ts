...
export class MonPortfolioService {
    monBlocks:MonPortfolio[]=[{
      titre:'Projet : Licence Professionnelle',
      description:`Création d'un carnet de suivie virtuel pour étudiant(s)(es) ingénieurs de L'EISINE`,
      createPortfolio:new Date(),
      resume:`Le but de ce projet est de transformer la gestion du suivi des apprentis ingénieur au sein de l’EiSINe par une plateforme
       collaborative.
      ...
      imageUrl:'https://media.istockphoto.com/id/1075599562/photo/programmer-working-with-program-code.jpg?b=1&s=612x612&w=0&k=20&c=-wTGItN4uscm4sy8X07O4YXhyl2xOBnc9DfzMyUKxJ0='
    },
    {
        titre:`Projet : Fin d'étude de BTS`,
        description:'Ruche connectée',
        createPortfolio:new Date(),
        resume:`La surveillance à distance des ruches est intéressante à plusieurs niveaux :
       ...
       imageUrl:'assets/images/IMG_20210318_141041.jpg'  
    },
    {
      titre:'Projet : BTS 1',
      description: 'Girouette',
      createPortfolio: new Date(),
      resume:`Le système doit permettre de donner l’orientation du vent.
      ...
      imageUrl:'assets/images/IMG_20200206_163025.jpg'
    }
];
    getAllMonPortfolio(): MonPortfolio[] {
        return this.monBlocks;
    }
}